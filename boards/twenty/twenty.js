let countries = ["poland", "czech", "germany", "ukraine", "russia", "lithuania", "slovakia", "belarus", "france", "italy"];
let drawn = [];
let repetitions = [];
...
function newGame() {
    let selectors = ["#one", "#two", "#three", "#four", "#five", "#six", "#seven", "#eight", "#nine", "#ten", "#eleven", "#twelve",  "#thirteen", 
